...
const Main = () => {
     return (
          <div className="container  px-4 mx-auto">
               <div className="lg:space-x-5 lg:flex lg:flex-row item:center flex flex-col-reverse text-center lg:text-left">
                    <div className="lg:mt-12">
                         ...
                         <div className="mt-6 text-gray-800 dark:text-white">
                              ...
                              <p className="mb-4">
                                   Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non, ex dolorem sint commodi perspiciatis amet?
                              </p>
                              <p className="mb-4">
                                   Lorem ipsum dolor sit amet consectetur, adipisicing elit. Non, ex dolorem sint commodi perspiciatis amet?
                              </p>
                    ...
                    <div className="flex justify-center mt-6">
                        <div
                            className="flex md:flex lg:flex sm:flex space-x-4 font-medium text-gray-800 dark:text-white">
                            <a className="transition-colors hover:text-sky-500" target="_blank" rel="noreferrer"
                               href="https://twitter.com/bro_riyadh">
